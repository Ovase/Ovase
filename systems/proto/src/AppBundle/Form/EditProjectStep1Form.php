...
class EditProjectStep1Form extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
            ...
            ->add('startdate', TextType::class,array('label' => 'Start dato', 'attr' => array('onchange' => 'disableDates()')))
            ->add('enddate', TextType::class, array('label' => 'Slutt dato'))
            ->add('location', TextType::class, array('label' => 'Lokasjon'))
            ->add('coordLat', HiddenType::class, array('data' => 0.0))
            ->add('coordLong', HiddenType::class, array('data' => 0.0))
            ->add('images', CollectionType::class, array('entry_type' => HiddenType::class, 'allow_delete' => true))
            ->add('imageFiles', FileType::class, array('required' => false, 'label' => 'Last opp bilder','mapped' => false, 'multiple' => true));
    }
