 ...
 * BASIC
 */
$config['site_title'] = 'Ovase';              // Site title
 ...
 * THEME
 */
$config['theme'] = 'ovase-theme';                // Set the theme (defaults to "default")
$config['twig_config'] = array(              // Twig settings
    'cache' => 'twig-cache',                        // To enable Twig caching change this to a path to a writable directory
